...
## Project Structure
    ...
    ├── testapiautoteammemb_83024  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_83024`
...
2. Clone this repo and `cd testapiautoteammemb_83024`
